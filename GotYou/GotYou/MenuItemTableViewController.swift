...
class MenuItemTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let item = menuSection.items[indexPath.row] as! MenuItem
        
        cell.itemName.text = String(item.menuName)
        cell.itemDescription.text = item.menuDescription
        cell.itemPrice.text = String(item.menuPrice)
